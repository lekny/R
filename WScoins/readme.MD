Estudo em R para ETL (Extract Transform Load) em criptomoedas, verificando condicionais nas variações % e exportando (.xlsx) arquivo acumulando no mesmo a cada execução do código. 
